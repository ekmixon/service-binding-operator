...
class ServerlessOperator(Operator):
    ...
    def is_running(self, wait=False):
        ...
        elif self.openshift.search_resource_in_namespace("csvs", currentCSV, self.openshift.operators_namespace) is None:
            return False
        ...
        for deployment in expectedDeployments:
            ...
            if found_pod_name is not None:
                ...
                print(f"The pod {found_pod_name} is running: {operator_pod_status}")
